    ...
    <div className="min-h-screen">
      ...
      <CenterContent className="block mt-16 mb-2 md:grid-cols-12 md:items-center md:justify-items-end md:divide-x-2">
        ...
        <div className='md:col-span-6 mt-12 md:mt-0 md:pl-10 flex flex-col items-start justify-center'>
          ...
          <p className='text-base lg:text-sm mt-14 lg:mt-9 leading-6 animate__text'>After I graduated from college, I decided to further develop myself into the digital world.</p>
      ...
      <div className="hidden md:block absolute right-0">
        <Marquee speed={15} gradient={false}>
          <h1 className="text-9xl text-black/30 font-light">Ommi Putera Karunia - Frontend Engineer - </h1>
        </Marquee>
      </div>
