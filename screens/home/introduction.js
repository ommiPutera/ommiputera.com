  ...
  return (
    <div className="min-h-screen">
      ...
      <CenterContent className="block mt-8 mb-2 md:flex md:items-center md:justify-center md:divide-x-2">
        <div className='md:col-span-1 flex items-center 2xl:ml-28 xl:ml-60 lg:ml-28 w-[250px] h-[250px] 2xl:w-[320px] 2xl:h-[320px] animate__pop__image'>
        ...
        <div className='md:col-span-1 mt-12 md:mt-0 md:pl-10 flex flex-col items-start justify-center'>
          ...
          <p className='text-sm mt-9 leading-6 animate__text'>After I graduated from college, I decided to further develop myself into the digital world which I think is more promising for my future career. Previously, I had expertise in graphic design such as Adobe Illustrator.</p>
          <span className="mt-5 animate__component">
