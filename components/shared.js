  ...
  return (
    <React.Fragment>
      <button
        onClick={onClick}
        className={clsx(
          "absolute md:fixed z-40 right-4 md:right-24 top-[25px] sm:top-10 md:top-16 bg-brown rounded-full p-3",
          `${scrollY > 30 ? "visible top-[18px] lg:animate__burger" : "visible md:invisible"}`
        )}
      >
        {
          open ?
