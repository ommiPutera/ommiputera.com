...
export default function Home() {
  return (
    <React.Fragment>
      <CenterContent className="block mt-8 md:flex md:items-center md:justify-center md:divide-x-2">
        ...
        <div className='md:col-span-1 mt-12 md:mt-0 md:pl-8 flex flex-col items-start justify-center'>
